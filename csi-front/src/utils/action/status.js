...
const STATUS_TEXT_MAP = {
  ...
  [ACTION_STATUS.PARTIALLY_COMPLETED]: '部分完成',
...
const STATUS_TAG_TYPE_MAP = {
  ...
  [ACTION_STATUS.PARTIALLY_COMPLETED]: 'warning',
...
export const getStatusDotClass = (status) => {
  const classMap = {
    ...
    [ACTION_STATUS.PARTIALLY_COMPLETED]: 'bg-violet-500',
...
export const getActionStatusIcon = (status) => {
  const map = {
    ...
    [ACTION_STATUS.PARTIALLY_COMPLETED]: { icon: 'mdi:circle-slice-5', bgClass: 'bg-violet-100', iconClass: 'text-violet-600' },
