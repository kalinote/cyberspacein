"""Tests for app.service.analyst.network_security — SSRF protection and internal URL detection."""
...
def test_blocks_ipv6_loopback():
    ...
    with patch("app.service.analyst.network_security.socket.getaddrinfo", _resolver):
