...
from app.service.nanobot.utils.helpers import build_assistant_message, current_time_str, detect_image_mime
...
class ContextBuilder:
    ...
    def _is_template_content(content: str, template_path: str) -> bool:
        ...
        try:
            tpl = pkg_files("app.service.nanobot") / "templates" / template_path
            if tpl.is_file():
