...
- [SKILL] 条目：在 skills/<name>/SKILL.md 下创建新技能
...
- 在 skills/<name>/SKILL.md 下创建新技能
- 写入前参考 `{{ skill_creator_path }}` 的格式（frontmatter 结构、命名约定、质量标准）
...
- 勿覆盖已有技能 — 若技能目录已存在则跳过
- 引用智能体可用的具体工具（例如 web_search、web_fetch 等）
- 技能是指令集而非代码 — 不要包含实现代码
